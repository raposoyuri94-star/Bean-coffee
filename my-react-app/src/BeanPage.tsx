  ...
  return <div className="site-shell">
    <header className="header">
      ...
      <nav id="site-nav" className={open ? 'nav open' : 'nav'} aria-label="Main navigation">
        <a href="#story" onClick={close}>Our story</a><a href="#menu" onClick={close}>Menu</a><a href="#visit" onClick={close}>Visit us</a><a className="nav-cta" href="#menu" onClick={close}>Order coffee <span>↗</span></a>
      </nav>
    </header>
    <main id="top">
